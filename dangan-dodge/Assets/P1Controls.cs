// GENERATED AUTOMATICALLY FROM 'Assets/P1Controls.inputactions'
...
public class @P1Controls : IInputActionCollection, IDisposable
{
    ...
    public struct DefaultActions
    {
        ...
        public DefaultActions(@P1Controls wrapper) { m_Wrapper = wrapper; }
